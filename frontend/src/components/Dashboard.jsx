          ...
          <table className="reports-table">
            <thead>
              <tr>
                ...
                <th>Client Name</th>
                <th style={{ width: '250px' }}>Completion Progress %</th>
                ...
                <tr key={proj.project_id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                      ...
                      <div className="progress-container" style={{ width: '100%', backgroundColor: '#e5e2db', borderRadius: '4px', height: '8px', overflow: 'hidden' }}>
                        <div className="progress-bar" style={{ width: `${proj.progress || 0}%`, backgroundColor: 'var(--accent-gold)', height: '100%', borderRadius: '4px', transition: 'width 0.4s ease' }}></div>
                      </div>
                    </div>
                  </td>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  ...
                  <div className="form-group">
                    ...
                    <input 
                      ...
                      onChange={(e) => setProjectProgress(Math.min(100, Math.max(0, parseInt(e.target.value) || 0)))}
                      disabled={modalLoading}
                    />
                  </div>
