      ...
      <div className="sidebar-panel" style={{ width: '100%', marginBottom: '2rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', padding: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div className="progress-container" style={{ flex: 1, backgroundColor: '#e5e2db', borderRadius: '4px', height: '12px', overflow: 'hidden' }}>
              <div className="progress-bar" style={{ width: `${project.progress || 0}%`, backgroundColor: 'var(--accent-gold)', height: '100%', borderRadius: '4px', transition: 'width 0.4s ease' }}></div>
            </div>
